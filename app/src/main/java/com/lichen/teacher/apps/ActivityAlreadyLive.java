...
// */
//public class ActivityAlreadyLive extends AppCompatActivity {
//
//    private LRecyclerView mListView;
//    private TextView mLoadingStatusView;
//    private LinearLayout mLoadingView;
//
//    private AlreadyLiveAdapter mLiveAdapter;
//    private List mTestData;
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_already_live_view);
//
//        initView();
//        setTestData();
//        setupListView();
...
//        mLiveAdapter = new AlreadyLiveAdapter(this);

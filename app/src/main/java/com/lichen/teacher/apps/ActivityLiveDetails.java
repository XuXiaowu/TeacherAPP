...
public class ActivityLiveDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_details_view);
...
//            startActivity(intent);
            Utils.showShare(ActivityLiveDetails.this, null, false, "www.baidu.com",
                    "title", "text---------");
        }
    };
